...
function Home() {
	return (
		<main className="flex min-h-[100dvh] flex-col items-center justify-center gap-10 px-8 py-12 md:gap-14 md:px-16 lg:gap-16 lg:px-24">
			<h1 className="w-full max-w-4xl text-center text-5xl font-medium tracking-tight text-foreground sm:text-6xl md:text-7xl lg:text-8xl lg:leading-[1.05]">
			...
			<div className="flex flex-wrap items-center justify-center gap-4 md:gap-6">
				<Button
					asChild
					size="lg"
					className="h-14 min-w-48 px-10 text-lg md:h-16 md:min-w-56 md:px-12 md:text-xl"
				>
