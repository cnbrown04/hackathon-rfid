...
public class RFIDSample4{
	...
	public static void main(String[] args) throws InterruptedException {
		...
		RFIDSample4 rfidBase = new RFIDSample4();
		
		// TODO Auto-generated method stub
		if (args.length > 0)
		{
			// Get the reader host name / IP address
			rfidBase.hostName = args[0];

			// Get the port number
			if (args.length > 1)
				rfidBase.port =  Integer.valueOf(args[1]);

		}
		
		
		// On Device, connect automatically to the reader
		rfidBase.connectToReader();
